...
{
    public partial class seedingfkfixed : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedOn = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false, defaultValue: new DateTime(2022, 12, 27, 17, 31, 53, 700, DateTimeKind.Local).AddTicks(391)),
                    LastModifiedBy = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    LastModifiedOn = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false, defaultValue: new DateTime(2022, 12, 27, 17, 31, 53, 700, DateTimeKind.Local).AddTicks(669)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedBy = table.Column<string>(type: "NVARCHAR2(2000)", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false, defaultValue: new DateTime(2022, 12, 27, 17, 31, 53, 700, DateTimeKind.Local).AddTicks(1454)),
                    LastModifiedBy = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    LastModifiedOn = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false, defaultValue: new DateTime(2022, 12, 27, 17, 31, 53, 700, DateTimeKind.Local).AddTicks(1641)),
                    Status = table.Column<bool>(type: "NUMBER(1)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BackgroundColor = table.Column<string>(type: "NVARCHAR2(2000)", nullable: false),
                    Color = table.Column<string>(type: "NVARCHAR2(2000)", nullable: false),
                    CreatedBy = table.Column<string>(type: "NVARCHAR2(2000)", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false, defaultValue: new DateTime(2022, 12, 27, 17, 31, 53, 700, DateTimeKind.Local).AddTicks(1962)),
                    LastModifiedBy = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    LastModifiedOn = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false, defaultValue: new DateTime(2022, 12, 27, 17, 31, 53, 700, DateTimeKind.Local).AddTicks(2189)),
                    Status = table.Column<bool>(type: "NUMBER(1)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedBy = table.Column<string>(type: "NVARCHAR2(2000)", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false, defaultValue: new DateTime(2022, 12, 27, 17, 31, 53, 700, DateTimeKind.Local).AddTicks(2406)),
                    LastModifiedBy = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    LastModifiedOn = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false, defaultValue: new DateTime(2022, 12, 27, 17, 31, 53, 700, DateTimeKind.Local).AddTicks(2614)),
                    Status = table.Column<bool>(type: "NUMBER(1)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedOn = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false, defaultValue: new DateTime(2022, 12, 27, 17, 31, 53, 700, DateTimeKind.Local).AddTicks(958)),
                    LastModifiedBy = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    LastModifiedOn = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false, defaultValue: new DateTime(2022, 12, 27, 17, 31, 53, 700, DateTimeKind.Local).AddTicks(1180)),
                    Status = table.Column<bool>(type: "NUMBER(1)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TicketStatusId = table.Column<Guid>(type: "RAW(16)", nullable: false),
                    GeneratedBy = table.Column<string>(type: "NVARCHAR2(2000)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Id = table.Column<Guid>(type: "RAW(16)", nullable: false),
                    CreatedBy = table.Column<string>(type: "NVARCHAR2(2000)", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false, defaultValue: new DateTime(2022, 12, 27, 17, 31, 53, 700, DateTimeKind.Local).AddTicks(2836)),
                    LastModifiedBy = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    LastModifiedOn = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false, defaultValue: new DateTime(2022, 12, 27, 17, 31, 53, 700, DateTimeKind.Local).AddTicks(3138)),
                    Status = table.Column<bool>(type: "NUMBER(1)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("504731d4-0a34-41d5-9b0b-0611b3f76096"), "AutoGenerated", new DateTime(2022, 12, 27, 17, 31, 53, 698, DateTimeKind.Local).AddTicks(8239), "fa-solid fa-plane-departure", "Tickets", "AutoGenerated", 1, "tickets", true },
                    { new Guid("504731d4-0a34-41d5-9b0b-0611b3f76098"), "AutoGenerated", new DateTime(2022, 12, 27, 17, 31, 53, 698, DateTimeKind.Local).AddTicks(8262), "fa-solid fa-plane-departure", "Usuarios", "AutoGenerated", 2, "users", true }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("504731d4-0a34-41d5-9b0b-0611b3f76777"), "#c8e6c9", "#256029", "AutoGenerated", new DateTime(2022, 12, 27, 17, 31, 53, 700, DateTimeKind.Local).AddTicks(195), "Estado del ticket resuelto", "AutoGenerated", "Resuelto", true });

            migrationBuilder.InsertData(
                table: "User",
                columns: new[] { "Id", "CreatedBy", "LastModifiedBy", "Name", "Password", "Status", "Username" },
                values: new object[,]
                {
                    { new Guid("4a77cee4-5cfa-4c90-b41a-08da36159120"), "AutoGenerated", "AutoGenerated", "Kevin Pontón", "8c6976e5b5410415bde908bd4dee15dfb167a9c873fc4bb8a81f6f2ab448a918", true, "Admin" },
                    { new Guid("c82a18c6-e473-4976-5f2e-08da35e4eb6f"), "AutoGenerated", "AutoGenerated", "Usuario", "03ac674216f3e15c761ee1a5e255f067953623c8b388b4459e13f978d7c846f4", true, "User" }
                });
